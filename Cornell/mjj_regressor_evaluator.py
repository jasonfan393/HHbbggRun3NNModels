...
parser = argparse.ArgumentParser(prog = 'ProgramName', description = 'placeholder', epilog = 'placeholder')
...
for file_path in file_paths:
  ...
  df_all = utils.load_parquet_file(file_path, loadAll = True) #load parquet with all variables
  ...
  destination_dir = destination_path.replace("NOTAG_merged.parquet","") #FIXME this is a hack
